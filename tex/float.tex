...
图要有图注，并置于图的编号之后，图的编号和图注应置于图下方的居中位置。引用图应在图题右上角标出文献来源。当插图中组成部件由数字或字母等编号表示时，可在插图下方添加图注进行说明，如图~\ref{fig:sdju-school-motto} 所示。若有需要添加双语图注，用法如图~\ref{fig:sdju-school-motto-2}所示。

\begin{figure}[!htp]
	\centering
	\includegraphics[width=10cm]{sdju-badge}
	\caption{上海电机学院校徽}
	\label{fig:sdju-school-motto}
\end{figure}

\begin{figure}[!htp]
	\centering
	\includegraphics[width=10cm]{sdju-badge}
	\bicaption{上海电机学院校徽}{Shanghai Dianji University Badge}
	\label{fig:sdju-school-motto-2}
\end{figure}
...
\begin{figure}[!htp]
  \centering
  \includegraphics[height=2cm]{images/sdju-badge}
  \hspace{1cm}
  \includegraphics[height=2cm]{images/sdju-badge}
  \caption{上海电机学院校徽}
...
\begin{figure}[!htp]
  \begin{minipage}{0.48\textwidth}
  	\centering
    \includegraphics[height=1.5cm]{images/sdju-badge}
    \caption{并排第一个图}
...
\begin{figure}[!htp]
  \subcaptionbox{上海电机学院校徽\label{fig:subcaptionbox-a}}%
	[0.5\textwidth]{%
	  \includegraphics[height=1.5cm]{images/sdju-badge}
	}
  \hfill
  \subcaptionbox{上海电机学院校名\label{fig:subcaptionbox-b}}%
    [0.5\textwidth]{%
	  \includegraphics[width=0.5\textwidth]{images/sdju-name}
	}
  \hfill
  \subcaptionbox{上海电机学院校徽\label{fig:subcaptionbox-c}}%
    [\textwidth]{%
	  \includegraphics[height=1.5cm]{images/sdju-badge}
  }
